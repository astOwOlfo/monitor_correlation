#!/bin/bash
# Training commands for the medical sycophancy environment.
# Not intended to be run directly, but rather to provide examples of commands used to train models for the paper

export SEED=${SEED:-1}
export ENV="medical_sycophancy"
export STEPS=400
export MONITOR_WEIGHT=1.0 # Monitor weight is the correctness reward weight in the hackable environment

# Non-default easier dataset used for the best intervention setups
export DATASET_EASY="results/data/icliniq_train_filtered_sycophancy_half_easy_1k.jsonl"

export JUDGE_PROMPT_KEY="monitor_medical_010"
export JUDGE_MODEL_ID="moonshotai/kimi-k2.5"
export JUDGE_THRESHOLD=0.7
